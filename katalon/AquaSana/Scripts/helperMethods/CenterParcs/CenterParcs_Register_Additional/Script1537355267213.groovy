...
if (GlobalVariable.postComms == true) {
    WebUI.scrollToElement(findTestObject('CenterParcs/Centerparcs_my_profile/postCommsCheckbox'), 0)
...
if (GlobalVariable.smsComms == true) {
    WebUI.scrollToElement(findTestObject('CenterParcs/Centerparcs_my_profile/smsCommsCheckBox'), 0)
