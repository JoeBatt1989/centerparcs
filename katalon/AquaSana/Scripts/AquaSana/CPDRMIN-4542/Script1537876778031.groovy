...
WebUI.callTestCase(findTestCase('helperMethods/AquaSana/AquaSana_Register_Base'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('helperMethods/AquaSana/AquaSana_Register_Additional'), [:], FailureHandling.STOP_ON_FAILURE)
